...
|------|-------------|---------|----------|
| components-root | Relative path to 'components' directory. Should not include 'components' directory itself. Default ''. If empty that means that 'components' is in root of the repository |  | true |
